...
<div class="page-table scrollable only-y" id="affix-container">
    <div class="card-base card-shadow--medium bg-white">
        <el-form ref="form" :rules="rules" :model="form">
            ...
            <el-row :gutter="10">
                <el-col :span="6">
                    <el-select v-model="form.position" filterable placeholder="Employee Position">
    ...
    data() {
        return {
            ...
            rules: {
                ...
                // attendance_latitude: [{
                //     required: true,
                //     message: "Employee Latitude is required!",
                //     trigger: "blur"
                // }],
                // attendance_longitude: [{
                //     required: true,
                //     message: "Employee Longitude is required!",
                //     trigger: "blur"
                // }],
            }
        };
            ...
            if (this.form.photo2) {
                ...
                this.$refs[formName].validate(valid => {
                    if (valid) {
                        ...
                        this.$store.dispatch(action.CREATE_DATA_EMPLOYEE, obj);
                    } else {
                        return false;
                    }
                });
