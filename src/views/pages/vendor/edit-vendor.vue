          ...
          <el-col :lg="12">
            <el-form-item prop="office_phone_number">
              <el-input
                ...
                placeholder="Vendor Office Phone Number"
          ...
          <el-col :lg="8">
            <el-form-item prop="pic_mobile_number">
              <el-input
                ...
                v-model="form.pic_mobile_number"
              ></el-input>
            </el-form-item>
          </el-col>
          <el-col :lg="8">
...
export default {
  ...
  created() {
    ...
    this.form.office_phone_number = this.vendor.office_phone_number;
    this.form.office_address = this.vendor.office_address;
    this.form.pic_name = this.vendor.pic_name;
    this.form.pic_mobile_number = this.vendor.pic_mobile_number;
    this.form.pic_email = this.vendor.pic_email;
  },
  methods: {
    onSubmit() {
