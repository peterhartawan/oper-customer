        ...
        <div class="card-base card-shadow--medium bg-white">
            <el-form ref="form" :rules="rules" :model="form">
                ...
                <el-row>
                    <el-col :span="24">
                        <el-col>
                            <p><b> Description </b> <span style="padding-left: 1.8em" v-if="data != null"> :   {{ data.task_template_description }}</span></p>
                        </el-col>
                    </el-col>
                </el-row>
        ...
        data() {
            ...
            return {
                ...
                rules: {
                    ...
                    booking_time: [
                        { required: true, message:'Please Input Date & Time', trigger: ['blur', 'change']},
                    ],
                    origin_latitude: [
                        { required: true, message:'Please Select Origin', trigger: ['blur', 'change']}
                    ],
                    destination_latitude: [
                        { required: true, message: 'Please Select Destination', trigger: ['blur', 'change'] }
                    ],
                    client_vehicle_license: [
                        { required: false, message:'Please Input Vehicle License', trigger: ['blur', 'change']},
                    ...
                    vehicle_owner:   [
                        { required: false, message: 'Please Input Vehicle Owner', trigger: ['blur', 'change'] }
                    ],
                    vehicle_brand:   [
