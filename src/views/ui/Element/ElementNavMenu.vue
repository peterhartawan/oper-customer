<template>
	<vue-scroll class="page-element-menu">
		<div class="page-header">
			<h1>Element NavMenu
				<theme-picker style="float:right"></theme-picker>
			</h1>
			<h4><a href="http://element.eleme.io/#/en-US/component/menu" target="_blank"><i class="mdi mdi-book-open-page-variant"></i> see from the complete documentation</a></h4>
		</div>
