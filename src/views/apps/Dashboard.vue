					...
					<div class="widget-header ph-20 pt-20">
						<div class="flex justify-center align-center">
							...
							<div class="widget-info box grow text-truncate animated fadeInLeft">
								<div class="o-050 widget-title text-truncate pt-5 pb-10">Total Order list</div>
				...
				<div class="card-base card-shadow--medium mb-30 widget small-widget" v-loading="!asyncComponent">
					...
					<div class="widget-header ph-20 pt-20">
						<div class="flex justify-center align-center">
							...
							<div class="widget-info box grow text-truncate animated fadeInLeft">
								<div class="o-050 widget-title text-truncate pt-5 pb-10">Total Order In Progress</div>
				...
				<div class="card-base card-shadow--medium mb-30 widget small-widget" v-loading="!asyncComponent">
					...
					<div class="widget-header ph-20 pt-20">
						<div class="flex justify-center align-center">
							...
							<div class="widget-info box grow text-truncate animated fadeInLeft">
								<div class="o-050 widget-title text-truncate pt-5 pb-10">Total Order Completed</div>
				...
				<div class="card-base card-shadow--medium mb-30 widget small-widget" v-loading="!asyncComponent">
					...
					<div class="widget-header ph-20 pt-20">
						<div class="flex justify-center align-center">
							...
							<div class="widget-info box grow text-truncate animated fadeInLeft">
								<div class="o-050 widget-title text-truncate pt-5 pb-10">Total Driver</div>
				...
				<div class="card-base card-shadow--medium mb-30 widget small-widget" v-loading="!asyncComponent">
					...
					<div class="widget-header ph-20 pt-20">
						<div class="flex justify-center align-center">
							...
							<div class="widget-info box grow text-truncate animated fadeInLeft">
								<div class="o-050 widget-title text-truncate pt-5 pb-10">Total Vendor</div>
								<h2 class="m-0 text-truncate">7.450</h2>
							</div>
						</div>
					</div>
